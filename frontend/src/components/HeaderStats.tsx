    ...
    return (
        ...
        >
            <HStack justify="space-between" wrap="wrap" gap={4}>
                ...
                <HStack gap={4}>
                    <HStack gap={1}>
                        ...
                        <Text fontSize="sm" fontWeight="bold">
                            {GAME_THEME.debugYearLabel} {silo.current_year} 年 {silo.current_month} 月
                        </Text>
                    </HStack>
                ...
                {/* Global Stats */}
                <HStack gap={4}>
                    <Tooltip content={`${GAME_THEME.schoolLabel}正统性。受管理决策和全局事件影响。`}>
                    ...
                    <Tooltip content={`${GAME_THEME.schoolLabel}动荡度。受弟子不满情绪和激进势力影响。`}>
                        <HStack gap={1} cursor="help">
                    ...
                    <Tooltip content={`${GAME_THEME.schoolLabel}总人数。`}>
                        <HStack gap={1} cursor="help">
                    ...
                    <Tooltip 
                        content={
                            <VStack align="start" gap={1} p={1}>
                                ...
                                <HStack justify="space-between" w="full">
                                    <Text>堂口修正 ({getDepartmentName(agent.profession)}):</Text>
                ...
                <Tooltip 
                    content={
                        <VStack align="start" gap={2}>
                            ...
                            <Box>
                                <Text fontWeight="bold" fontSize="xs" mb={1}>已知情报</Text>
                                <HStack wrap="wrap" gap={1}>
                                    {agent.known_fragments?.map(f => (
                                        <Badge key={f} colorPalette="purple" size="xs" variant="solid">{formatFragmentLabel(f)}</Badge>
                                    ))}
                                </HStack>
                            </Box>
                        </VStack>
                ...
                >
                    <HStack gap={2} cursor="help">
                        ...
                        <Badge colorPalette="purple" size="sm">{getDepartmentName(agent.profession)}</Badge>
                    </HStack>
                </Tooltip>
            </HStack>
        </Box>
