...
import { CAMPUS_OPTIONS, GAME_THEME } from '../gameTheme';
...
const SILO_OPTIONS: SiloOption[] = CAMPUS_OPTIONS;
                    ...
                    <VStack gap={2} w="full">
                        ...
                        {!showManual ? (
                            ...
                            <VStack w="full" gap={3} mt={2}>
                                <Text fontSize="sm" color="gray.400">选择你想加入的{GAME_THEME.campusLabel}：</Text>
