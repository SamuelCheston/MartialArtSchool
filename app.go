...
import (
	...
	"embed"
	"log"
	"martialartschool/internal/api"
	"martialartschool/internal/cache"
	"martialartschool/internal/config"
	"martialartschool/internal/engine"
	"martialartschool/internal/model"
	"martialartschool/internal/repository"
	"martialartschool/internal/service"
	"os"
	"time"
...
func (a *App) startup(ctx context.Context) {
	...
	db, err := repository.InitDB(config.DatabaseFile)
	if err != nil {
	...
	a.debugHTTPAPI = api.NewDebugHTTPServer(os.Getenv(config.DebugHTTPEnv), a)
